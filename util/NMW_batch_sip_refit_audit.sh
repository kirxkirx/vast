...
#
# Usage:
#   util/NMW_batch_sip_refit_audit.sh <image_list_file> <output_dir> [N_workers] [max_load]
#
...
# yielding plenty of stars for the UCAC5 matching and the SIP refit.
# This and the other telephoto_lens configs are NMW-specific - hence the
# NMW in this script's name. Change WORKER_DEFAULT_SEX below for other
# cameras.
...
WORKER_DEFAULT_SEX="default.sex.telephoto_lens_onlybrightstars_v1"
