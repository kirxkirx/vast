...
$GREP_RESULT"
  ...
  RADECPOSITION_TO_TEST=`grep "2019 11 03.6470  2458791.1470  11\.1.  19:03:" -e "2019 11 03.6470  2458791.1470  11\.2.  19:03:" -e "2019 11 03.6470  2458791.1470  11\.3.  19:03:" transient_report/index.html | awk '{print $6" "$7}'`
