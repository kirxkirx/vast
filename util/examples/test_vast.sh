...
if [ ! -d ../NMW_Aql11_NovaHer21_test ];then
 cd ..
 wget -c "http://scan.sai.msu.ru/~kirx/pub/NMW_Aql11_NovaHer21_test.tar.bz2" && tar -xvjf NMW_Aql11_NovaHer21_test.tar.bz2 && rm -f NMW_Aql11_NovaHer21_test.tar.bz2
 cd $WORKDIR
fi
# If the test data are found
if [ -d ../NMW_Aql11_NovaHer21_test ];then
 ...
 util/clean_data.sh
 # Run the test
 echo "NMW find Nova Her 2021 test " >> /dev/stderr
...
$GREP_RESULT"
 ...
 # Make an overall conclusion for this test
 if [ $TEST_PASSED -eq 1 ];then
  echo -e "\n\033[01;34mNMW find Nova Her 2021 test \033[01;32mPASSED\033[00m" >> /dev/stderr
  echo "PASSED" >> vast_test_report.txt
 else
  echo -e "\n\033[01;34mNMW find Nova Her 2021 test \033[01;31mFAILED\033[00m" >> /dev/stderr
  echo "FAILED" >> vast_test_report.txt
 fi
else
...
# cd ..
# wget -c "http://scan.sai.msu.ru/~kirx/pub/NMW_find_NovaCas21_test.tar.bz2" && tar -xvjf NMW_find_NovaCas21_test.tar.bz2 && rm -f NMW_find_NovaCas21_test.tar.bz2
# cd $WORKDIR
#fi
# If the test data are found
if [ -d ../NMW_find_NovaCas21_test ];then
 ...
 util/clean_data.sh
 # Run the test
 echo "NMW find Nova Cas 2021 test " >> /dev/stderr
...
$GREP_RESULT"
 ...
 # Make an overall conclusion for this test
 if [ $TEST_PASSED -eq 1 ];then
  echo -e "\n\033[01;34mNMW find Nova Cas 2021 test \033[01;32mPASSED\033[00m" >> /dev/stderr
  echo "PASSED" >> vast_test_report.txt
 else
...
# cd ..
# wget -c "http://scan.sai.msu.ru/~kirx/pub/NMW_Sco6_NovaSgr21N2_test.tar.bz2" && tar -xvjf NMW_Sco6_NovaSgr21N2_test.tar.bz2 && rm -f NMW_Sco6_NovaSgr21N2_test.tar.bz2
# cd $WORKDIR
#fi
# If the test data are found
if [ -d ../NMW_Sco6_NovaSgr21N2_test ];then
 ...
 util/clean_data.sh
 # Run the test
 echo "NMW find Nova Sgr 2021 N2 test " >> /dev/stderr
...
$GREP_RESULT"
 ...
 # Make an overall conclusion for this test
 if [ $TEST_PASSED -eq 1 ];then
  echo -e "\n\033[01;34mNMW find Nova Sgr 2021 N2 test \033[01;32mPASSED\033[00m" >> /dev/stderr
  echo "PASSED" >> vast_test_report.txt
 else
  echo -e "\n\033[01;34mNMW find Nova Sgr 2021 N2 test \033[01;31mFAILED\033[00m" >> /dev/stderr
  echo "FAILED" >> vast_test_report.txt
 fi
# No else HERE AS THIS IS A SPECIAL TEST PERFORMED ONLY ON SELECTED MACHINES
#else
...
# cd ..
# wget -c "http://scan.sai.msu.ru/~kirx/pub/NMW_Sgr7_NovaSgr21N1_test.tar.bz2" && tar -xvjf NMW_Sgr7_NovaSgr21N1_test.tar.bz2 && rm -f NMW_Sgr7_NovaSgr21N1_test.tar.bz2
# cd $WORKDIR
#fi
# If the test data are found
if [ -d ../NMW_Sgr7_NovaSgr21N1_test ];then
 ...
 util/clean_data.sh
 # Run the test
 echo "NMW find Nova Sgr 2021 N1 test " >> /dev/stderr
...
$GREP_RESULT"
 ...
 # Make an overall conclusion for this test
 if [ $TEST_PASSED -eq 1 ];then
  echo -e "\n\033[01;34mNMW find Nova Sgr 2021 N1 test \033[01;32mPASSED\033[00m" >> /dev/stderr
  echo "PASSED" >> vast_test_report.txt
 else
  echo -e "\n\033[01;34mNMW find Nova Sgr 2021 N1 test \033[01;31mFAILED\033[00m" >> /dev/stderr
  echo "FAILED" >> vast_test_report.txt
 fi
# No else HERE AS THIS IS A SPECIAL TEST PERFORMED ONLY ON SELECTED MACHINES
#else
...
# cd ..
# wget -c "http://scan.sai.msu.ru/~kirx/pub/NMW_find_Mars_test.tar.bz2" && tar -xvjf NMW_find_Mars_test.tar.bz2 && rm -f NMW_find_Mars_test.tar.bz2
# cd $WORKDIR
#fi
# If the test data are found
if [ -d ../NMW_find_Mars_test ];then
 ...
 util/clean_data.sh
 # Run the test
 echo "NMW find Mars test " >> /dev/stderr
...
$GREP_RESULT"
 ...
 # Make an overall conclusion for this test
 if [ $TEST_PASSED -eq 1 ];then
  echo -e "\n\033[01;34mNMW find Mars test \033[01;32mPASSED\033[00m" >> /dev/stderr
  echo "PASSED" >> vast_test_report.txt
 else
  echo -e "\n\033[01;34mNMW find Mars test \033[01;31mFAILED\033[00m" >> /dev/stderr
  echo "FAILED" >> vast_test_report.txt
 fi
# No else HERE AS THIS IS A SPECIAL TEST PERFORMED ONLY ON SELECTED MACHINES
#else
...
if [ ! -f ../individual_images_test/LIGHT_21-22-58_B_-42.00_60.00s_0001.fits ];then
 ...
 cd ../individual_images_test
 wget -c "http://scan.sai.msu.ru/~kirx/pub/LIGHT_21-22-58_B_-42.00_60.00s_0001.fits.bz2" && bunzip2 LIGHT_21-22-58_B_-42.00_60.00s_0001.fits.bz2
 cd $WORKDIR
fi
...
if [ -f ../individual_images_test/LIGHT_21-22-58_B_-42.00_60.00s_0001.fits ];then
 ...
 util/clean_data.sh
 # Run the test
 echo "Sintez 380mm image 2 test " >> /dev/stderr
 ...
 # Make an overall conclusion for this test
 if [ $TEST_PASSED -eq 1 ];then
  echo -e "\n\033[01;34mSintez 380mm image 2 test \033[01;32mPASSED\033[00m" >> /dev/stderr
  echo "PASSED" >> vast_test_report.txt
 else
  echo -e "\n\033[01;34mSintez 380mm image 2 test \033[01;31mFAILED\033[00m" >> /dev/stderr
  echo "FAILED" >> vast_test_report.txt
 fi
else
