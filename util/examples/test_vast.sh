...
$GREP_RESULT"
  ...
  grep --quiet "2024 03 11.106.  2460380.606.  10\...  17:39:57\... -26:27:42\.." transient_report/index.html
  if [ $? -ne 0 ];then
   TEST_PASSED=0
   FAILED_TEST_CODES="$FAILED_TEST_CODES NMWSTLNOPH24314a"
  fi
  RADECPOSITION_TO_TEST=`grep "2024 03 11.106.  2460380.606.  10\...  17:39:57\... -26:27:42\.." transient_report/index.html | awk '{print $6" "$7}' | head -n1`
  ...
  grep --quiet "2024 03 11\.106.  2460380\.606.  10\...  18:17:20\... -28:09:50\.." transient_report/index.html
  if [ $? -ne 0 ];then
   TEST_PASSED=0
   FAILED_TEST_CODES="$FAILED_TEST_CODES NMWSTLNOPH24415a"
  fi
  RADECPOSITION_TO_TEST=`grep "2024 03 11\.106.  2460380\.606.  10\...  18:17:20\... -28:09:50\.." transient_report/index.html | awk '{print $6" "$7}'`
