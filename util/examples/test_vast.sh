...
$GREP_RESULT"
  ...
  grep --quiet "2023 07 19.892.  2460145.392.  12\...  00:18:..\... -03:14:3.\.." transient_report/index.html
  if [ $? -ne 0 ];then
   TEST_PASSED=0
   FAILED_TEST_CODES="$FAILED_TEST_CODES NMWSTLFINDNEPTUNE714a"
  fi
  RADECPOSITION_TO_TEST=`grep "2023 07 19.892.  2460145.392.  12\...  00:18:..\... -03:14:3.\.." transient_report/index.html | awk '{print $6" "$7}' | head -n1`
