...
69.380895 30.769591
69.772106 30.890582
curl --insecure --connect-timeout 10 --retry 1 --max-time 300 -F file=@scan_ucac5_test.input -F submit=Upload Image -F brightmag=2.000000 -F faintmag=13.500000 -F searcharcsec=23.350000 'http://vast.sai.msu.ru/cgi-bin/ucac5/search_ucac5.py' 
