...
#
#" 1>&2
DATABASE_RESULTS=$($TIMEOUTCOMMAND $CURL $VAST_CURL_PROXY --silent --max-time 90 "http://www.sai.msu.su/gcvs/cgi-bin/co-h.cgi?coor=${RA//:/+}+${DEC_STUPID_PLUS_GCVS//:/+}&radius=60" | grep \| )
