...
for POSSIBLE_LIBRARY_PATH in /opt/X11/lib /usr/X11R6/lib /usr/lib/X11 /usr/local/lib/X11 /usr/lib64/X11 /usr/local/lib64/X11 /usr/lib32/X11 /usr/local/lib32/X11 ;do
...
for POSSIBLE_LIBRARY_PATH in /opt/X11/include /usr/X11R6/include /usr/include/X11 /usr/local/include/X11 ;do
 if [ -d "$POSSIBLE_LIBRARY_PATH" ];then
