...
shell_commands: pgplot_components lib/lightcurve_simulator vast
	...
	cd util && ln -s identify.sh identify_noninteractive.sh && ln -s identify.sh identify_justname.sh && ln -s identify.sh wcs_image_calibration.sh && ln -s identify.sh wcs_image_catalog.sh && ln -s identify.sh identify_transient.sh && ln -s identify.sh identify_for_catalog.sh && cd -
	#
...
clean: clean_libraries
	...
	rm -f util/wcs_image_calibration.sh util/wcs_image_catalog.sh util/identify_transient.sh util/identify_for_catalog.sh util/identify_noninteractive.sh util/identify_justname.sh
