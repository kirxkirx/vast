...
#define N_FORK 0         // Number of SExtractor threads running in parallel
                         ...
                         // The number of threads may be manually controlled by 
...
#define MAX_NOROTATION_ANGLE_RAD M_PI * 15.0 / 180.0     // Maximum image rotation allowed by --norotation option
...
#define MIN_NUMBER_STARS_ZEROPOINT_MAG_CALIB 20                                   // Minimum number of automatically matched stars for zeropoint-only magnitude calibration
...
#define M_SIGMA_BIN_MAG_SIGMA_DETECT 0.7 // Increase this parameter if you want more conservative candidate selection
...
// This affects only the legacy sigma plot (2nd column in data.m_sigma and vast_lightcurve_statistics.log )
