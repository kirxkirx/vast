 ...
 case DTVIG:
  if ( datestring != NULL ) {
   ...
   case DTFITS:
    ...
    if ( outtime == ET )
     newfdate= fd2et( fitsdate );
    else if ( outtime == GST )
     newfdate= fd2gst( fitsdate );
    else if ( outtime == MST )
     newfdate= fd2mst( fitsdate );
    else if ( outtime == LST )
     newfdate= fd2lst( fitsdate );
    else
     newfdate= fitsdate;
  ...
  if ( datestring != NULL ) {
   ...
   case DTFITS:
    ...
    if ( outtime == ET )
     ...
     newfdate= fd2gst( newfdate );
    else if ( outtime == MST )
     newfdate= fd2mst( newfdate );
    else if ( outtime == LST )
     newfdate= fd2lst( newfdate );
    tchar= strchr( newfdate, 'T' );
    if ( tchar == NULL )
     tchar= strchr( newfdate, 'S' );
    if ( dateonly ) {
  ...
  if ( datestring != NULL ) {
   ...
   case DTFITS:
    ...
    if ( outtime == ET )
     ...
     fitsdate= fd2gst( fitsdate );
    else if ( outtime == MST )
     fitsdate= fd2mst( fitsdate );
    else if ( outtime == LST )
     fitsdate= fd2lst( fitsdate );
