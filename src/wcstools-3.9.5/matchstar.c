...
void
    setresid_refine( refine ) int refine;
{
 resid_refine= refine;
 return;
}

int getresid_refine() { return ( resid_refine ); }

void
    setnfit( nfit ) int nfit;
{
 if ( nfit == 0 )
  setnofit();
 else if ( nfit < 0 ) {
...
int getnfit() { return ( pfit0 ); }

int iscdfit() { return ( cdfit ); }

void
    setminmatch( minmatch ) int minmatch;
{
 minmatch0= minmatch;
 return;
}
