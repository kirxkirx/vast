...
void settabkrw( keyword0 ) char *keyword0;
{
 kwt= keyword0;
 return;
}
...
void
    setreflim( lim1, lim2 ) double lim1,
    lim2;
{
 refmag2= lim2;
 if ( lim1 > -2.0 )
...
void
    setminstars( minstars ) int minstars;
{
 minstars0= minstars;
 setminbin( minstars );
 return;
...
void
    setrecenter( recenter ) int recenter;
{
 recenter0= recenter;
 return;
}
