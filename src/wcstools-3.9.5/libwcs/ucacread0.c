...
static int
    ucaczones( dec1, dec2, nzmax, zones, verbose )
        ...
        double dec1,
    dec2;    /* Declination limits in degrees */
...

{
 ...
 if ( ucat == UCAC1 && iz2 > 169 )
  iz2= 169;
 if ( ucat == UCAC2 && iz2 > 288 )
  iz2= 288;
 if ( ucat == UCAC3 && iz2 > 360 )
  iz2= 360;
 if ( iz1 > iz2 )
  return ( 0 );
...
void
    ucacclose( sc ) struct StarCat *sc; /* Star catalog descriptor */
{
 fclose( sc->ifcat );
 free( sc );
 return;
