...
void version( char *version_string ) {
 strcpy( version_string, "VaST 1.0rc85" );
 return;
}
...
void set_transient_search_boundaries( double *search_area_boundaries, struct Star *star, int NUMBER, double X_im_size, double Y_im_size ) {
 int i;
 search_area_boundaries[0]= search_area_boundaries[1]= search_area_boundaries[2]= search_area_boundaries[3]= 2 * FRAME_EDGE_INDENT_PIXELS;
