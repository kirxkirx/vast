...
#define ACCEPT_DISTANCE_ARCSEC 1 // look no further if there is a match within ACCEPT_DISTANCE_ARCSEC

#define MAX_DISTANCE_DEGREES MAX_DISTANCE_ARCSEC / 3600.0
#define ACCEPT_DISTANCE_DEGREES ACCEPT_DISTANCE_ARCSEC / 3600.0
