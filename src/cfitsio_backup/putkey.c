...
*/
{
 ...
 if ( comm ) {
  commlen= strlen( comm );
  if ( commlen > 47 )
   commlen= 47; /* only guarantee preserving the first 47 characters */
 }
 ...
 while ( remain > 0 ) {
  ...
  if ( remain > nchar ) /* if string is continued, put & as last char */
  {
   ...
   else {                     /* last char was a pair of single quotes, so over write both */
    valstring[vlen - 3]= '&';
    valstring[vlen - 1]= '\0';
   }
  }
...
*/
{
 ...
 if ( slen == 8 && datestr[2] == '/' && datestr[5] == '/' ) {
  if ( isdigit( (int)datestr[0] ) && isdigit( (int)datestr[1] ) && isdigit( (int)datestr[3] ) && isdigit( (int)datestr[4] ) && isdigit( (int)datestr[6] ) && isdigit( (int)datestr[7] ) ) {
  ...
  if ( isdigit( (int)datestr[0] ) && isdigit( (int)datestr[1] ) && isdigit( (int)datestr[2] ) && isdigit( (int)datestr[3] ) && isdigit( (int)datestr[5] ) && isdigit( (int)datestr[6] ) && isdigit( (int)datestr[8] ) && isdigit( (int)datestr[9] ) ) {
...
*/
{
 ...
 if ( datestr[2] == '/' || datestr[4] == '-' ) {
  ...
  if ( slen == 8 || slen == 10 )
   ...
   if ( isdigit( (int)datestr[11] ) && isdigit( (int)datestr[12] ) && isdigit( (int)datestr[14] ) && isdigit( (int)datestr[15] ) && isdigit( (int)datestr[17] ) && isdigit( (int)datestr[18] ) ) {
...
*/
{
 ...
 if ( ( fptr->Fptr )->curhdu == 0 ) { /* write primary array header */
  if ( simple )
 ...
 } else { /* write IMAGE extension header */
...
*/
{
 ...
 if ( decim < 0 ) { /* use G format if decim is negative */
