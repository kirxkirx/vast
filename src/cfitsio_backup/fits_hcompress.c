...
*/
   ...
   b[k]= ( ( a[s10 + 1] & b0 ) | ( ( a[s10] << 1 ) & b1 ) | ( ( a[s00 + 1] << 2 ) & b2 ) | ( ( a[s00] << 3 ) & b3 ) ) >> bit;
...
qtree_onebit64( LONGLONG a[], int n, int nx, int ny, unsigned char b[], int bit ) {
 ...
 for ( i= 0; i < nx - 1; i+= 2 ) {
  ...
  s10= s00 + n; /* s10 is index of a[i+1,j]	*/
  for ( j= 0; j < ny - 1; j+= 2 ) {
   b[k]= (unsigned char)( ( ( a[s10 + 1] & b0 ) | ( ( a[s10] << 1 ) & b1 ) | ( ( a[s00 + 1] << 2 ) & b2 ) | ( ( a[s00] << 3 ) & b3 ) ) >> bit );
   k+= 1;
   s00+= 2;
   s10+= 2;
  }
  if ( j < ny ) {
   /*
			 ...
			 * s00+1,s10+1 are off edge
			 */
   b[k]= (unsigned char)( ( ( ( a[s10] << 1 ) & b1 ) | ( ( a[s00] << 3 ) & b3 ) ) >> bit );
   k+= 1;
  }
 }
 if ( i < nx ) {
  ...
  s00= n * i;
  for ( j= 0; j < ny - 1; j+= 2 ) {
   b[k]= (unsigned char)( ( ( ( a[s00 + 1] << 2 ) & b2 ) | ( ( a[s00] << 3 ) & b3 ) ) >> bit );
   k+= 1;
   s00+= 2;
  }
  if ( j < ny ) {
...
qtree_reduce( unsigned char a[], int n, int nx, int ny, unsigned char b[] ) {
 ...
 for ( i= 0; i < nx - 1; i+= 2 ) {
  ...
  s10= s00 + n; /* s10 is index of a[i+1,j]	*/
  for ( j= 0; j < ny - 1; j+= 2 ) {
   b[k]= ( a[s10 + 1] != 0 ) | ( ( a[s10] != 0 ) << 1 ) | ( ( a[s00 + 1] != 0 ) << 2 ) | ( ( a[s00] != 0 ) << 3 );
   k+= 1;
   s00+= 2;
   s10+= 2;
  }
