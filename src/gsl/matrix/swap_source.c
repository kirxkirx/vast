...
int FUNCTION( gsl_matrix, swap_rows )( TYPE( gsl_matrix ) * m,
...
int FUNCTION( gsl_matrix, swap_columns )( TYPE( gsl_matrix ) * m,
                                          const size_t i, const size_t j ) {
 const size_t size1= m->size1;
 const size_t size2= m->size2;
...
int FUNCTION( gsl_matrix, swap_rowcol )( TYPE( gsl_matrix ) * m,
                                         const size_t i, const size_t j ) {
 const size_t size1= m->size1;
 const size_t size2= m->size2;
...
int FUNCTION( gsl_matrix, transpose )( TYPE( gsl_matrix ) * m ) {
 const size_t size1= m->size1;
 const size_t size2= m->size2;
 size_t i, j, k;
...
int FUNCTION( gsl_matrix, transpose_memcpy )( TYPE( gsl_matrix ) * dest,
...
int FUNCTION( gsl_matrix, transpose_tricpy )( const char uplo_src,
