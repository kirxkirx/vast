...
FUNCTION( gsl_matrix, row )
( QUALIFIED_TYPE( gsl_matrix ) * m, const size_t i ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
...
QUALIFIED_VIEW( _gsl_vector, view )
FUNCTION( gsl_matrix, column )
( QUALIFIED_TYPE( gsl_matrix ) * m, const size_t j ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
...
QUALIFIED_VIEW( _gsl_vector, view )
FUNCTION( gsl_matrix, diagonal )
( QUALIFIED_TYPE( gsl_matrix ) * m ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
...
QUALIFIED_VIEW( _gsl_vector, view )
FUNCTION( gsl_matrix, subdiagonal )
( QUALIFIED_TYPE( gsl_matrix ) * m,
  const size_t k ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
...
QUALIFIED_VIEW( _gsl_vector, view )
FUNCTION( gsl_matrix, superdiagonal )
( QUALIFIED_TYPE( gsl_matrix ) * m,
  const size_t k ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
...
QUALIFIED_VIEW( _gsl_vector, view )
FUNCTION( gsl_matrix, subrow )
( QUALIFIED_TYPE( gsl_matrix ) * m, const size_t i, const size_t offset, const size_t n ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
...
QUALIFIED_VIEW( _gsl_vector, view )
FUNCTION( gsl_matrix, subcolumn )
( QUALIFIED_TYPE( gsl_matrix ) * m, const size_t j, const size_t offset, const size_t n ) {
 QUALIFIED_VIEW( _gsl_vector, view )
 view= NULL_VECTOR_VIEW;
