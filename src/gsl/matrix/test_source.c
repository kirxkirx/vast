...
void FUNCTION( test, func )( const size_t M, const size_t N ) {
 ...
 FUNCTION( gsl_matrix, free )
 ( m ); /* free whatever is in m */
...

 {
...

  {
   ...
   FUNCTION( gsl_matrix, minmax_index )
   ( m, &imin, &jmin, &imax, &jmax );
...
void FUNCTION( test, ops )( const size_t M, const size_t N ) {
 ...
 FUNCTION( gsl_matrix, memcpy )
 ( m, a );
 FUNCTION( gsl_matrix, mul_elements )
 ( m, b );
 ...
 FUNCTION( gsl_matrix, memcpy )
 ( m, a );
 FUNCTION( gsl_matrix, div_elements )
 ( m, b );
 ...
 FUNCTION( gsl_matrix, memcpy )
 ( m, a );
 FUNCTION( gsl_matrix, add_constant )
 ( m, 3.0 );
 ...
 FUNCTION( gsl_matrix, memcpy )
 ( m, a );
 FUNCTION( gsl_matrix, add_diagonal )
 ( m, 5.0 );
...
void FUNCTION( test, binary_noncontiguous )( const size_t M, const size_t N ) {
 ...
 m= FUNCTION( gsl_matrix, submatrix )( l, 0, 0, M, N );
...

 {
  ...
  VIEW( gsl_matrix, view )
  mm= FUNCTION( gsl_matrix, submatrix )( ll, 0, 0, M, N );
  status= 0;
