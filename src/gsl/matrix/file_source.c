...
int FUNCTION( gsl_matrix, fread )( FILE *stream, TYPE( gsl_matrix ) * m ) {
 int status= 0;
...
int FUNCTION( gsl_matrix, fwrite )( FILE *stream, const TYPE( gsl_matrix ) * m ) {
 int status= 0;
...
int FUNCTION( gsl_matrix, fprintf )( FILE *stream, const TYPE( gsl_matrix ) * m,
                                     const char *format ) {
 int status= 0;
...
int FUNCTION( gsl_matrix, fscanf )( FILE *stream, TYPE( gsl_matrix ) * m ) {
 int status= 0;
