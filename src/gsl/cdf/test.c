...
void test_discrete_cdf_P( double ( *pdf )( unsigned int ),
...
void test_discrete_cdf_Q( double ( *pdf )( unsigned int ),
...
void test_discrete_cdf_PQ( double ( *cdf_P )( unsigned int ),
                           double ( *cdf_Q )( unsigned int ),
                           struct range ( *range )( void ),
                           const char *desc ) {
 double sum;
