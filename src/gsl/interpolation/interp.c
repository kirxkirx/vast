...
#define DISCARD_STATUS( s )                               \
 if ( ( s ) != GSL_SUCCESS ) {                            \
  GSL_ERROR_VAL( "interpolation error", ( s ), GSL_NAN ); \
 }
...
int gsl_interp_eval_e( const gsl_interp *interp,
...
int gsl_interp_eval_deriv_e( const gsl_interp *interp,
                             const double xa[], const double ya[], double x,
                             gsl_interp_accel *a,
                             double *dydx ) {
 if ( x < interp->xmin || x > interp->xmax ) {
...
int gsl_interp_eval_deriv2_e( const gsl_interp *interp,
                              const double xa[], const double ya[], double x,
                              gsl_interp_accel *a,
                              double *d2 ) {
 if ( x < interp->xmin || x > interp->xmax ) {
...
int gsl_interp_eval_integ_e( const gsl_interp *interp,
