...
int gsl_spline_eval_e( const gsl_spline *spline,
                       double x,
...
int gsl_spline_eval_deriv_e( const gsl_spline *spline,
                             double x,
                             gsl_interp_accel *a,
                             double *dydx ) {
...
int gsl_spline_eval_deriv2_e( const gsl_spline *spline,
                              double x,
                              gsl_interp_accel *a,
                              double *d2 ) {
...
int gsl_spline_eval_integ_e( const gsl_spline *spline,
                             double a, double b,
