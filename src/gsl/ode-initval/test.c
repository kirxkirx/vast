...
int jac_vl( double t, const double y[], double *dfdy, double dfdt[],
            void *params ) {
 const double a= 1.0;
 const double b= 1.0;
 const double c= 1.0;
...
int jac_e5( double t, const double y[], double *dfdy, double dfdt[],
            void *params ) {
 const double a= 7.89e-10;
 const double b= 1.1e7;
 const double c= 1.13e3;
...
void test_odeiv_stepper( const gsl_odeiv_step_type *T, const gsl_odeiv_system *sys,
...
void test_stepper( const gsl_odeiv_step_type *T ) {
...
int sys_driver( const gsl_odeiv_step_type *T,
                const gsl_odeiv_system *sys,
                double t0, double t1, double hstart,
...
void test_compare_vanderpol( void ) {
...
void test_compare_oregonator( void ) {
...
void test_evolve_linear( const gsl_odeiv_step_type *T, double h, double err ) {
 double y[1];
 double yfin[1];
...
void test_evolve_xsin( const gsl_odeiv_step_type *T, double h, double err ) {
 double y[2];
 double yfin[2];
 y[0]= 1.0;
 y[1]= 0.0;
...
void test_evolve_negative_h( const gsl_odeiv_step_type *T, double h, double err ) {
 /* Tolerance factor in testing errors */
 const double factor= 10;
