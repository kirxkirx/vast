...
void func1_fdf( double x, void *p, double *y, double *yprime ) {
 *y= func1( x, p );
...
void func2_fdf( double x, void *p, double *y, double *yprime ) {
 *y= func2( x, p );
...
void func3_fdf( double x, void *p, double *y, double *yprime ) {
 *y= func3( x, p );
 *yprime= 2 * x;
}
...
void func4_fdf( double x, void *p, double *y, double *yprime ) {
 *y= func4( x, p );
...
void func5_fdf( double x, void *p, double *y, double *yprime ) {
 *y= func5( x, p );
...
void func6_fdf( double x, void *p, double *y, double *yprime ) {
 *y= func6( x, p );
...
void sin_fdf( double x, void *p, double *y, double *yprime ) {
 *y= sin( x );
 *yprime= cos( x );
}
...
void cos_fdf( double x, void *p, double *y, double *yprime ) {
 *y= cos( x );
 *yprime= -sin( x );
}
