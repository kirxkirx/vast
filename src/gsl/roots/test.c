...
void test_f( const gsl_root_fsolver_type *T, const char *description, gsl_function *f,
...
void test_f_e( const gsl_root_fsolver_type *T,
...
void test_fdf( const gsl_root_fdfsolver_type *T, const char *description,
...
void test_fdf_e( const gsl_root_fdfsolver_type *T,
