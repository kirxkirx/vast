...
int FUNCTION( gsl_dft_complex, forward )( const BASE data[],
...
int FUNCTION( gsl_dft_complex, backward )( const BASE data[],
                                           const size_t stride, const size_t n,
                                           BASE result[] ) {
...
int FUNCTION( gsl_dft_complex, inverse )( const BASE data[],
                                          const size_t stride, const size_t n,
                                          BASE result[] ) {
 gsl_fft_direction sign= gsl_fft_backward;
 int status= FUNCTION( gsl_dft_complex, transform )( data, stride, n, result, sign );
...
int FUNCTION( gsl_dft_complex, transform )( const BASE data[],
                                            const size_t stride, const size_t n,
                                            BASE result[],
