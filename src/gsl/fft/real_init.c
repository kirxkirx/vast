...
void FUNCTION( gsl_fft_real_wavetable, free )( TYPE( gsl_fft_real_wavetable ) * wavetable ) {
...
void FUNCTION( gsl_fft_real_workspace, free )( TYPE( gsl_fft_real_workspace ) * workspace ) {
