...
void FUNCTION( gsl_fft_complex_wavetable, free )( TYPE( gsl_fft_complex_wavetable ) * wavetable ) {
...
void FUNCTION( gsl_fft_complex_workspace, free )( TYPE( gsl_fft_complex_workspace ) * workspace ) {
...
int FUNCTION( gsl_fft_complex, memcpy )( TYPE( gsl_fft_complex_wavetable ) * dest,
