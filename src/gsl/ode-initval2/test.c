...
int rhs_xsin( double t, const double y[], double f[], void *params ) {
 static int n= 0, m= 0;
 extern int nfe;
 nfe+= 1;
...
int jac_xsin( double t, const double y[], double *dfdy, double dfdt[],
              void *params ) {
 static int n= 0;
 extern int nje;
 nje+= 1;
...
int rhs_broken( double t, const double y[], double f[], void *params ) {
 if ( t < 10.0 ) {
  f[0]= 1.0;
 }
...
int jac_broken( double t, const double y[], double *dfdy, double dfdt[],
                void *params ) {
 if ( t < 10.0 ) {
  dfdy[0]= 0.0;
  dfdt[0]= 0.0;
...
int rhs_sin_ub( double t, const double y[], double f[], void *params ) {
 extern int nfe;
 nfe+= 1;
...
int jac_sin_ub( double t, const double y[], double *dfdy, double dfdt[],
                void *params ) {
 extern int nje;
 nje+= 1;
...
int rhs_br( double t, const double *y, double *dydt, void *params ) {
 dydt[0]= ( rand() - RAND_MAX / 2 ) * 2e100;
 return GSL_SUCCESS;
}

int jac_br( double t, const double y[], double *dfdy, double dfdt[], void *params ) {
...
int jac_stepfn( double t, const double y[], double *dfdy, double dfdt[],
                void *params ) {
 dfdy[0]= 0.0;
 dfdt[0]= 0.0;
...
int rhs_vl( double t, const double y[], double f[], void *params ) {
 const double a= -1.0;
 const double b= -1.0;
 const double c= -2.0;
 const double d= -1.0;
...
int jac_vl( double t, const double y[], double *dfdy, double dfdt[], void *params ) {
 const double a= -1.0;
 const double b= -1.0;
 const double c= -2.0;
 const double d= -1.0;
...
int rhs_vanderpol( double t, const double y[], double f[], void *params ) {
...
int jac_vanderpol( double t, const double y[], double *dfdy, double dfdt[],
                   void *params ) {
 const double mu= 10.0;
...
int rhs_stifftrig( double t, const double y[], double f[], void *params ) {
 extern int nfe;
 nfe+= 1;
...
int jac_stifftrig( double t, const double y[], double *dfdy, double dfdt[],
                   void *params ) {
 extern int nje;
 nje+= 1;
...
int rhs_oregonator( double t, const double y[], double f[], void *params ) {
...
int jac_oregonator( double t, const double y[], double *dfdy, double dfdt[],
                    void *params ) {
 const double c1= 77.27;
 const double c2= 8.375e-6;
 const double c3= 0.161;
...
int rhs_e5( double t, const double y[], double f[], void *params ) {
...
int jac_e5( double t, const double y[], double *dfdy, double dfdt[], void *params ) {
 const double a= 7.89e-10;
 const double b= 1.1e7;
 const double c= 1.13e3;
 const double m= 1.0e6;
...
int rhs_robertson( double t, const double y[], double f[], void *params ) {
 const double a= 0.04;
...
int jac_robertson( double t, const double y[], double *dfdy, double dfdt[],
                   void *params ) {
 const double a= 0.04;
 const double b= 1.0e4;
 const double c= 3.0e7;
...
int rhs_brusselator( double t, const double y[], double f[], void *params ) {
 const double a= 1.0;
 const double b= 3.0;
...
int jac_brusselator( double t, const double y[], double *dfdy, double dfdt[],
                     void *params ) {
 const double b= 3.0;
...
int jac_ringmod( double t, const double y[], double *dfdy, double dfdt[],
                 void *params ) {
 const double c= 1.6e-8;
 const double cs= 2e-12;
 const double cp= 1e-8;
...
void test_odeiv_stepper( const gsl_odeiv2_step_type *T,
...
void test_stepper( const gsl_odeiv2_step_type *T ) {
...
void test_evolve_system( const gsl_odeiv2_step_type *T,
...
int sys_driver( const gsl_odeiv2_step_type *T,
                const gsl_odeiv2_system *sys,
                double t0, double t1, double hstart,
...
void test_evolve_linear( const gsl_odeiv2_step_type *T, double h, double err ) {
 /* Test linear evolve */
...
void test_evolve_exp( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_evolve_sin( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_evolve_xsin( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_evolve_stiff1( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_evolve_stiff5( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_evolve_negative_h( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_broken( const gsl_odeiv2_step_type *T, double h, double err ) {
...
void test_stepsize_fail( const gsl_odeiv2_step_type *T, double h ) {
...
void test_user_break( const gsl_odeiv2_step_type *T, double h ) {
...
void test_stepfn( const gsl_odeiv2_step_type *T ) {
...
void test_stepfn2( const gsl_odeiv2_step_type *T ) {
...
void test_nonstiff_problems( void ) {
...
void test_extreme_problems( void ) {
...
void test_driver( const gsl_odeiv2_step_type *T ) {
...
#define CONST_BENCHMARK_PRECISION_NPROB 3
 ...
 for ( p= 0; p < CONST_BENCHMARK_PRECISION_NPROB; p++ ) {
  ...
  printf( "benchmark_precision: number of function/jacobian evaluations with %s\n          epsrel:   ",
          probname[p] );
...
void test_evolve_temp( const gsl_odeiv2_step_type *T, double h, double err ) {
 /* Temporary test */
