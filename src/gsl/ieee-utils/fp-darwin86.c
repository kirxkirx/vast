...
#define _FPU_GETCW( cw ) __asm__ __volatile__( "fnstcw %0" \
                                               : "=m"( *&cw ) )
#define _FPU_SETCW( cw ) __asm__ __volatile__( "fldcw %0" \
                                               :          \
                                               : "m"( *&cw ) )
...
#define _FPU_GETMXCSR( cw_sse ) asm volatile( "stmxcsr %0" \
                                              : "=m"( cw_sse ) )
#define _FPU_SETMXCSR( cw_sse ) asm volatile( "ldmxcsr %0" \
                                              :            \
                                              : "m"( cw_sse ) )
