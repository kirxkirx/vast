...
int roth_fdf( const gsl_vector *x, void *params,
              gsl_vector *f, gsl_matrix *df ) {
 roth_f( x, params, f );
 roth_df( x, params, df );
...
int powellscal_fdf( const gsl_vector *x, void *params,
                    gsl_vector *f, gsl_matrix *df ) {
...
int brownscal_fdf( const gsl_vector *x, void *params,
                   gsl_vector *f, gsl_matrix *df ) {
...
int powellsing_fdf( const gsl_vector *x, void *params,
                    gsl_vector *f, gsl_matrix *df ) {
...
int wood_fdf( const gsl_vector *x, void *params,
              gsl_vector *f, gsl_matrix *df ) {
 wood_f( x, params, f );
 wood_df( x, params, df );
...
int helical_fdf( const gsl_vector *x, void *params,
                 gsl_vector *f, gsl_matrix *df ) {
...
int dbv_fdf( const gsl_vector *x, void *params,
             gsl_vector *f, gsl_matrix *df ) {
 dbv_f( x, params, f );
 dbv_df( x, params, df );
...
int trig_fdf( const gsl_vector *x, void *params,
              gsl_vector *f, gsl_matrix *df ) {
 trig_f( x, params, f );
 trig_df( x, params, df );
