...
gsl_complex
gsl_complex_polar( double r, double theta ) { /* return z = r exp(i theta) */
 gsl_complex z;
...
double
gsl_complex_arg( gsl_complex z ) { /* return arg(z),  -pi < arg(z) <= +pi */
 double x= GSL_REAL( z );
 double y= GSL_IMAG( z );
...
double
gsl_complex_abs( gsl_complex z ) { /* return |z| */
 return hypot( GSL_REAL( z ), GSL_IMAG( z ) );
}

double
gsl_complex_abs2( gsl_complex z ) { /* return |z|^2 */
 double x= GSL_REAL( z );
 double y= GSL_IMAG( z );
...
double
gsl_complex_logabs( gsl_complex z ) { /* return log|z| */
...
gsl_complex
gsl_complex_add( gsl_complex a, gsl_complex b ) { /* z=a+b */
...
gsl_complex
gsl_complex_add_real( gsl_complex a, double x ) { /* z=a+x */
 gsl_complex z;
...
gsl_complex
gsl_complex_add_imag( gsl_complex a, double y ) { /* z=a+iy */
 gsl_complex z;
...
gsl_complex
gsl_complex_sub( gsl_complex a, gsl_complex b ) { /* z=a-b */
 double ar= GSL_REAL( a ), ai= GSL_IMAG( a );
 double br= GSL_REAL( b ), bi= GSL_IMAG( b );
...
gsl_complex
gsl_complex_sub_real( gsl_complex a, double x ) { /* z=a-x */
 gsl_complex z;
 GSL_SET_COMPLEX( &z, GSL_REAL( a ) - x, GSL_IMAG( a ) );
 return z;
}
...
gsl_complex
gsl_complex_sub_imag( gsl_complex a, double y ) { /* z=a-iy */
 gsl_complex z;
 GSL_SET_COMPLEX( &z, GSL_REAL( a ), GSL_IMAG( a ) - y );
 return z;
}
...
gsl_complex
gsl_complex_mul( gsl_complex a, gsl_complex b ) { /* z=a*b */
 double ar= GSL_REAL( a ), ai= GSL_IMAG( a );
 double br= GSL_REAL( b ), bi= GSL_IMAG( b );
...
gsl_complex
gsl_complex_mul_real( gsl_complex a, double x ) { /* z=a*x */
 gsl_complex z;
...
gsl_complex
gsl_complex_mul_imag( gsl_complex a, double y ) { /* z=a*iy */
 gsl_complex z;
...
gsl_complex
gsl_complex_div( gsl_complex a, gsl_complex b ) { /* z=a/b */
 double ar= GSL_REAL( a ), ai= GSL_IMAG( a );
 double br= GSL_REAL( b ), bi= GSL_IMAG( b );
...
gsl_complex
gsl_complex_div_real( gsl_complex a, double x ) { /* z=a/x */
 gsl_complex z;
...
gsl_complex
gsl_complex_div_imag( gsl_complex a, double y ) { /* z=a/(iy) */
 gsl_complex z;
...
gsl_complex
gsl_complex_conjugate( gsl_complex a ) { /* z=conj(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_negative( gsl_complex a ) { /* z=-a */
 gsl_complex z;
 GSL_SET_COMPLEX( &z, -GSL_REAL( a ), -GSL_IMAG( a ) );
 return z;
}
...
gsl_complex
gsl_complex_inverse( gsl_complex a ) { /* z=1/a */
...
gsl_complex
gsl_complex_sqrt( gsl_complex a ) { /* z=sqrt(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_sqrt_real( double x ) { /* z=sqrt(x) */
 gsl_complex z;
...
gsl_complex
gsl_complex_exp( gsl_complex a ) { /* z=exp(a) */
...
gsl_complex
gsl_complex_pow( gsl_complex a, gsl_complex b ) { /* z=a^b */
 gsl_complex z;
...
gsl_complex
gsl_complex_pow_real( gsl_complex a, double b ) { /* z=a^b */
 gsl_complex z;
...
gsl_complex
gsl_complex_log( gsl_complex a ) { /* z=log(a) */
 double logr= gsl_complex_logabs( a );
 double theta= gsl_complex_arg( a );
...
gsl_complex
gsl_complex_log10( gsl_complex a ) { /* z = log10(a) */
...
gsl_complex
gsl_complex_sin( gsl_complex a ) { /* z = sin(a) */
...
gsl_complex
gsl_complex_cos( gsl_complex a ) { /* z = cos(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
...
gsl_complex
gsl_complex_tan( gsl_complex a ) { /* z = tan(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
...
gsl_complex
gsl_complex_sec( gsl_complex a ) { /* z = sec(a) */
 gsl_complex z= gsl_complex_cos( a );
 return gsl_complex_inverse( z );
}

gsl_complex
gsl_complex_csc( gsl_complex a ) { /* z = csc(a) */
 gsl_complex z= gsl_complex_sin( a );
 return gsl_complex_inverse( z );
}

gsl_complex
gsl_complex_cot( gsl_complex a ) { /* z = cot(a) */
...
gsl_complex
gsl_complex_arcsin( gsl_complex a ) { /* z = arcsin(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
 gsl_complex z;
...
gsl_complex
gsl_complex_arcsin_real( double a ) { /* z = arcsin(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_arccos( gsl_complex a ) { /* z = arccos(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
 gsl_complex z;
...
gsl_complex
gsl_complex_arccos_real( double a ) { /* z = arccos(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_arctan( gsl_complex a ) { /* z = arctan(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
 gsl_complex z;
...
gsl_complex
gsl_complex_arcsec( gsl_complex a ) { /* z = arcsec(a) */
 gsl_complex z= gsl_complex_inverse( a );
 return gsl_complex_arccos( z );
}

gsl_complex
gsl_complex_arcsec_real( double a ) { /* z = arcsec(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_arccsc( gsl_complex a ) { /* z = arccsc(a) */
 gsl_complex z= gsl_complex_inverse( a );
 return gsl_complex_arcsin( z );
}

gsl_complex
gsl_complex_arccsc_real( double a ) { /* z = arccsc(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_arccot( gsl_complex a ) { /* z = arccot(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_sinh( gsl_complex a ) { /* z = sinh(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
...
gsl_complex
gsl_complex_cosh( gsl_complex a ) { /* z = cosh(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
...
gsl_complex
gsl_complex_tanh( gsl_complex a ) { /* z = tanh(a) */
 double R= GSL_REAL( a ), I= GSL_IMAG( a );
...
gsl_complex
gsl_complex_sech( gsl_complex a ) { /* z = sech(a) */
 gsl_complex z= gsl_complex_cosh( a );
 return gsl_complex_inverse( z );
}

gsl_complex
gsl_complex_csch( gsl_complex a ) { /* z = csch(a) */
 gsl_complex z= gsl_complex_sinh( a );
 return gsl_complex_inverse( z );
}

gsl_complex
gsl_complex_coth( gsl_complex a ) { /* z = coth(a) */
...
gsl_complex
gsl_complex_arcsinh( gsl_complex a ) { /* z = arcsinh(a) */
...
gsl_complex
gsl_complex_arccosh( gsl_complex a ) { /* z = arccosh(a) */
...
gsl_complex
gsl_complex_arccosh_real( double a ) { /* z = arccosh(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_arctanh( gsl_complex a ) { /* z = arctanh(a) */
 if ( GSL_IMAG( a ) == 0.0 ) {
...
gsl_complex
gsl_complex_arctanh_real( double a ) { /* z = arctanh(a) */
 gsl_complex z;
...
gsl_complex
gsl_complex_arcsech( gsl_complex a ) { /* z = arcsech(a); */
 gsl_complex t= gsl_complex_inverse( a );
 return gsl_complex_arccosh( t );
}

gsl_complex
gsl_complex_arccsch( gsl_complex a ) { /* z = arccsch(a) */
 gsl_complex t= gsl_complex_inverse( a );
 return gsl_complex_arcsinh( t );
}

gsl_complex
gsl_complex_arccoth( gsl_complex a ) { /* z = arccoth(a) */
 gsl_complex t= gsl_complex_inverse( a );
