...
int gsl_wavelet2d_transform_matrix( const gsl_wavelet *w,
                                    gsl_matrix *a,
                                    gsl_wavelet_direction dir,
                                    gsl_wavelet_workspace *work ) {
...
int gsl_wavelet2d_transform_matrix_forward( const gsl_wavelet *w,
                                            gsl_matrix *a,
                                            gsl_wavelet_workspace *work ) {
 return gsl_wavelet2d_transform( w, a->data,
                                 a->tda, a->size1, a->size2,
...
int gsl_wavelet2d_transform_matrix_inverse( const gsl_wavelet *w,
                                            gsl_matrix *a,
                                            gsl_wavelet_workspace *work ) {
 return gsl_wavelet2d_transform( w, a->data,
                                 a->tda, a->size1, a->size2,
...
int gsl_wavelet2d_nstransform_matrix( const gsl_wavelet *w,
                                      gsl_matrix *a,
                                      gsl_wavelet_direction dir,
                                      gsl_wavelet_workspace *work ) {
...
int gsl_wavelet2d_nstransform_matrix_forward( const gsl_wavelet *w,
                                              gsl_matrix *a,
                                              gsl_wavelet_workspace *work ) {
 return gsl_wavelet2d_nstransform( w, a->data,
                                   a->tda, a->size1, a->size2,
...
int gsl_wavelet2d_nstransform_matrix_inverse( const gsl_wavelet *w,
                                              gsl_matrix *a,
                                              gsl_wavelet_workspace *work ) {
 return gsl_wavelet2d_nstransform( w, a->data,
                                   a->tda, a->size1, a->size2,
