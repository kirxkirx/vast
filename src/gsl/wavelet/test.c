...
void test_1d( size_t N, size_t stride, const gsl_wavelet_type *T, size_t member );

void test_2d( size_t N, size_t tda, const gsl_wavelet_type *T, size_t member, int type );
