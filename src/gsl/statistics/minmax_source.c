...
BASE FUNCTION( gsl_stats, max )( const BASE data[], const size_t stride,
                                 const size_t n ) {
...
BASE FUNCTION( gsl_stats, min )( const BASE data[], const size_t stride,
                                 const size_t n ) {
...
void FUNCTION( gsl_stats, minmax )( BASE *min_out, BASE *max_out,
...
void FUNCTION( gsl_stats, minmax_index )( size_t *min_index_out,
