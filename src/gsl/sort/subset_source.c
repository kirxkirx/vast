...
int FUNCTION( gsl_sort, smallest )( BASE *dest, const size_t k,
...
int FUNCTION( gsl_sort_vector, smallest )( BASE *dest, const size_t k,
                                           const TYPE( gsl_vector ) * v ) {
 return FUNCTION( gsl_sort, smallest )( dest, k, v->data, v->stride, v->size );
}

int FUNCTION( gsl_sort, largest )( BASE *dest, const size_t k,
                                   const BASE *src, const size_t stride,
                                   const size_t n ) {
 size_t i, j;
 BASE xbound;
...
int FUNCTION( gsl_sort_vector, largest )( BASE *dest, const size_t k,
                                          const TYPE( gsl_vector ) * v ) {
