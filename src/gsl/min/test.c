...
void test_f( const gsl_min_fminimizer_type *T,
...
void test_f_e( const gsl_min_fminimizer_type *T,
               const char *description, gsl_function *f,
               double lower_bound, double middle, double upper_bound,
               double correct_minimum ) {
 int status;
...
int test_bracket( const char *description, gsl_function *f, double lower_bound,
