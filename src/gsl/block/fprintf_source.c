...
int FUNCTION( gsl_block, fprintf )( FILE *stream, const TYPE( gsl_block ) * b, const char *format ) {
 size_t n= b->size;
...
int FUNCTION( gsl_block, fscanf )( FILE *stream, TYPE( gsl_block ) * b ) {
 size_t n= b->size;
...
int FUNCTION( gsl_block, raw_fprintf )( FILE *stream,
                                        const ATOMIC *data,
                                        const size_t n,
                                        const size_t stride,
                                        const char *format ) {
...
int FUNCTION( gsl_block, raw_fscanf )( FILE *stream,
                                       ATOMIC *data,
                                       const size_t n,
                                       const size_t stride ) {
 size_t i;
