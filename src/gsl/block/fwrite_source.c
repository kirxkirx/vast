...
int FUNCTION( gsl_block, fread )( FILE *stream, TYPE( gsl_block ) * b ) {
 size_t n= b->size;
...
int FUNCTION( gsl_block, fwrite )( FILE *stream, const TYPE( gsl_block ) * b ) {
 size_t n= b->size;
...
int FUNCTION( gsl_block, raw_fread )( FILE *stream, ATOMIC *data,
...
int FUNCTION( gsl_block, raw_fwrite )( FILE *stream, const ATOMIC *data,
                                       const size_t n, const size_t stride ) {
