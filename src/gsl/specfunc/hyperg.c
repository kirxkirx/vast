...
int gsl_sf_hyperg_1F1_series_e( const double a, const double b, const double x,
...
int gsl_sf_hyperg_1F1_large_b_e( const double a, const double b, const double x, gsl_sf_result *result ) {
 if ( fabs( x / b ) < 1.0 ) {
  const double u= x / b;
...
int gsl_sf_hyperg_U_large_b_e( const double a, const double b, const double x,
                               gsl_sf_result *result,
 ...
 */
int gsl_sf_hyperg_2F0_series_e( const double a, const double b, const double x,
                                int n_trunc,
                                gsl_sf_result *result ) {
