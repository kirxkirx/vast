...
static int FUNCTION( legendre, array_schmidt_e )( const size_t lmax, const double x, const double csphase, OUTPUT_ARG );
static int FUNCTION( legendre, array_none_e )( const size_t lmax, const double x, const double csphase, OUTPUT_ARG );
...
int FUNCTION( gsl_sf_legendre, array )( const gsl_sf_legendre_t norm, const size_t lmax, const double x,
                                        OUTPUT_ARG ) {
...
int FUNCTION( gsl_sf_legendre, array_e )( const gsl_sf_legendre_t norm, const size_t lmax, const double x,
...
static int
FUNCTION( legendre, array_schmidt_e )( const size_t lmax, const double x, const double csphase, OUTPUT_ARG ) {
 if ( x > 1.0 || x < -1.0 ) {
...
static int
FUNCTION( legendre, array_none_e )( const size_t lmax, const double x, const double csphase, OUTPUT_ARG ) {
 if ( x > 1.0 || x < -1.0 ) {
  GSL_ERROR( "x is outside [-1,1]", GSL_EDOM );
 }
#if defined( LEGENDRE_DERIV ) || defined( LEGENDRE_DERIV2 )
