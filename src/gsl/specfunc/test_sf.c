...
/* Check a result against a given value and tolerance.
 */
int test_sf_check_e10( char *message_buff, int e10, int e10_in ) {
 int s= 0;
...
int test_sf( gsl_sf_result r, double val_in, double tol, int status,
...
int test_sf_e10( gsl_sf_result_e10 re, double val_in, int e10_in, double tol, int status,
                 int expect_return, const char *desc ) {
 char message_buff[4096];
 int local_s= 0;
 gsl_sf_result r;
...
int test_sf_rlx( gsl_sf_result r, double val_in, double tol, int status,
                 int expect_return, const char *desc ) {
 char message_buff[4096];
 int local_s= 0;
...
int test_sf_2( gsl_sf_result r1, double val1, double tol1,
...
int test_sf_sgn( gsl_sf_result r, double sgn, double val_in, double tol, double expect_sgn, int status,
                 int expect_return, const char *desc ) {
 char message_buff[4096];
