...
int FUNCTION( gsl_vector, equal )( const TYPE( gsl_vector ) * u, const TYPE( gsl_vector ) * v ) {
...
int FUNCTION( gsl_vector, ispos )( const TYPE( gsl_vector ) * v ) {
 const size_t n= v->size;
 const size_t stride= v->stride;
...
int FUNCTION( gsl_vector, isneg )( const TYPE( gsl_vector ) * v ) {
 const size_t n= v->size;
 const size_t stride= v->stride;
...
int FUNCTION( gsl_vector, isnonneg )( const TYPE( gsl_vector ) * v ) {
 const size_t n= v->size;
 const size_t stride= v->stride;
