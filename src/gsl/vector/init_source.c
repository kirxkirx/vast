...
void FUNCTION( gsl_vector, set_all )( TYPE( gsl_vector ) * v, BASE x ) {
...
void FUNCTION( gsl_vector, set_zero )( TYPE( gsl_vector ) * v ) {
 ATOMIC *const data= v->data;
 const size_t n= v->size;
 const size_t stride= v->stride;
...
int FUNCTION( gsl_vector, set_basis )( TYPE( gsl_vector ) * v, size_t i ) {
 ATOMIC *const data= v->data;
 const size_t n= v->size;
 const size_t stride= v->stride;
 const BASE zero= ZERO;
