...
int FUNCTION( gsl_vector, add )( TYPE( gsl_vector ) * a, const TYPE( gsl_vector ) * b ) {
...
int FUNCTION( gsl_vector, sub )( TYPE( gsl_vector ) * a, const TYPE( gsl_vector ) * b ) {
 const size_t N= a->size;
...
int FUNCTION( gsl_vector, div )( TYPE( gsl_vector ) * a, const TYPE( gsl_vector ) * b ) {
 const size_t N= a->size;
...
int FUNCTION( gsl_vector, scale )( TYPE( gsl_vector ) * a, const BASE x ) {
 const size_t N= a->size;
...
int FUNCTION( gsl_vector, add_constant )( TYPE( gsl_vector ) * a, const BASE x ) {
 const size_t N= a->size;
 const size_t stride= a->stride;
