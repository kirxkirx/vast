...

{
 ...
 if ( ( pstr= strpbrk( tnxstr, "1234567890-+." ) ) ) {
  ...
  tnxaxis->xorder= ( pstr= strtok_r( NULL, " ", &ptr ) ) ? (int)( atof( pstr ) + 0.5 ) : 0;
  tnxaxis->yorder= ( pstr= strtok_r( NULL, " ", &ptr ) ) ? (int)( atof( pstr ) + 0.5 ) : 0;
  tnxaxis->xterms= ( pstr= strtok_r( NULL, " ", &ptr ) ) ? (int)( atof( pstr ) + 0.5 ) : 0;
  ...
  case TNX_XNONE:
   ...
   break;
  case TNX_XHALF:
   order= tnxaxis->xorder < tnxaxis->yorder ? tnxaxis->xorder : tnxaxis->yorder;
