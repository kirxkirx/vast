...
static void pg_colour_setup( COLOUR *c ) {
 ...
 c[0].r= 255;
 c[0].g= 255;
 c[0].b= 255; /* White (background) */
 c[1].r= 0;
 c[1].g= 0;
 c[1].b= 0; /* Black (default) */
 c[2].r= 255;
 c[2].g= 0;
 c[2].b= 0; /* Red */
 c[3].r= 0;
 ...
 c[5].r= 0;
 c[5].g= 255;
 c[5].b= 255; /* Cyan (Green + Blue) */
 c[6].r= 255;
 c[6].g= 0;
 c[6].b= 255; /* Magenta (Red + Blue) */
 c[7].r= 255;
 c[7].g= 255;
 c[7].b= 0; /* Yellow (Red + Green) */
 c[8].r= 255;
 c[8].g= 128;
 c[8].b= 0; /* Red + Yellow (Orange) */
 c[9].r= 128;
 c[9].g= 255;
 c[9].b= 0; /* Green + Yellow */
 c[10].r= 0;
 c[10].g= 255;
 c[10].b= 128; /* Green + Cyan */
 c[11].r= 0;
 c[11].g= 128;
 c[11].b= 255; /* Blue + Cyan */
 c[12].r= 128;
 c[12].g= 0;
 c[12].b= 255; /* Blue + Magenta */
 c[13].r= 255;
 c[13].g= 0;
 c[13].b= 128; /* Red + Magenta */
 c[14].r= 84;
 c[14].g= 84;
 c[14].b= 84; /* Dark Gray */
 c[15].r= 168;
 c[15].g= 168;
 c[15].b= 168; /* Light Gray */
 for ( count= 16; count < 256; count++ ) {
  c[count].r= 0;
  c[count].g= 0;
  c[count].b= 0; /* make the rest Black */
 }
 return;
}
...
#ifdef _WIN32
void __stdcall CGDRIV( ifunc, rbuf, nbuf, chr, len, lchr, mode ) int *ifunc, *nbuf, *lchr, *mode;
unsigned len;
float rbuf[];
char *chr;
{
#elif defined( VMS )
void CGDRIV( ifunc, rbuf, nbuf, chrdsc, lchr, mode ) int *ifunc;
float rbuf[];
int *nbuf;
...
#else
void CGDRIV( ifunc, rbuf, nbuf, chr, lchr, mode, len ) int *ifunc, *nbuf, *lchr, *mode;
int len;
float rbuf[];
char *chr;
{
