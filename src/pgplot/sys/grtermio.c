...
#include <string.h> // to explicitly declare strncpy()
#include <unistd.h> // for read() write() and close()

// The following three includes are for open()
#include <sys/types.h>
#include <sys/stat.h>
#include <fcntl.h>
 ...
 */
int GROTER( cdev, ldev, cdev_len ) char *cdev;
int *ldev;
int cdev_len;
{
 ...
 */
void GRWTER( fd, cbuf, lbuf, cbuf_len ) int *fd;
char *cbuf;
int *lbuf;
int cbuf_len;
{
 ...
 */
void GRPTER( fd, cprom, lprom, cbuf, lbuf, cprom_len, cbuf_len ) int *fd;
char *cprom;
int *lprom;
char *cbuf;
int *lbuf;
